...
name: job-scraper
description: >
  Searches Australian job sources for new positions matching your profile. Deduplicates across runs.
...
This skill searches Australian job sources using targeted queries based on your profile, deduplicates against previously seen jobs and the application tracker, and presents new matches with a quick fit assessment.
...
For each search:
- Use targeted searches across SEEK, LinkedIn Australia, Workforce Australia, APS Jobs, and company ATS pages
...
7. **Australia-first defaults.** Do not use the Danish portal CLIs unless the user explicitly asks for Denmark. Prefer the country-agnostic LinkedIn tool and web searches for Australian boards.
