...
10. **Australia-first defaults.** Do not use the Danish portal CLIs unless the user explicitly asks for Denmark. Prefer the country-agnostic LinkedIn and freehire tools plus web searches for Australian boards.
